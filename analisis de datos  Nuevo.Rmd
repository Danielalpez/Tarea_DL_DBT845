...
# NUEVO Ruta de acceso general para cualquier usuario
```{r}
...
# ESTE BLOQUENO CORRE PORQUE NO ESTAN CREADOS LOS OBJETOS - REVISAR
```{r}
...
# ESTE BLOQUE NO CORRE PORQUE LA FIGURA ES DEMASIADO GRANDE
Se recomienda usar ggplot2() + facet_wrap
Quitting from lines 78-101 (analisis-de-datos--Nuevo.Rmd) 
...
# ESTE BLOQUE NO CORRE PORQUE NO EXISTE LA VARIABLE TNFa_PROM DENTRO DEL COBJETO expresion_genica
...
# ERROR EN INSTALACION DE PAQUETES
- DEBE ESTAR AL INICIO DEL SCRIPT
- UNA VEZ INSTALADO DEBE DESABILITAR PARA NO TENER QUE INSTALAR CADA VEZ
